...
```{r pvalex, fig.width = 7, fig.height = 3.5, out.width = "100%", fig.cap = "Daily $\\text{NO}_2$ pollutant concentrations in `r pv_station` (weekdays only) during `r pv_month` 2020 and `r pv_month` 2017-2019."}
